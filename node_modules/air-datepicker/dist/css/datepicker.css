...
.datepicker--nav-title i {
  ...
  src: url("../../../../src/fonts/Quicksand-Bold.woff") format("truetype");
  font-size: 17px;
  color: #1f2041;
...
.datepicker .control-buttons span[data-action="hide"] {
  color: #bc9cff;
}
.datepicker .control-buttons span[data-action="clear"] {
  color: rgba(31, 32, 65, 0.5);
}
